...
var s = e + "";
e >= 1e15 ? s = Math.floor(e / 1e15) + "P" : e >= 1e12 ? s = Math.floor(e / 1e12) + "T" : e >= 1e9 ? s = Math.floor(e / 1e9) + "G" : e >= 1e6 ? s = Math.floor(e / 1e6) + "M" : e >= 1e3 && (s = Math.floor(e / 1e3) + "K");
...
newBall: function(e) {
for (var t = this.KhungNode.children, n = !1, o = 0, a = 0, s = 0; s < t.length; s++) if (cc.isValid(t[s]) && "Ball" === t[s].name && (h = t[s].getComponent("Ball"))) if (1 === h.status) t[s].destroy(); else if (2 === h.status) {
a++;
var c = t[s].y + h.radius;
if (c > 850) {
n = !0;
c > 940 && o++;
}
...
var l = null, h = (l = 4 === e ? cc.instantiate(this.BoomNode) : 5 === e ? cc.instantiate(this.X2Node) : cc.instantiate(this.ballPre)).getComponent("Ball");
l.name = "Ball";
l.active = !0;
...
var r = 2;
if (1 === e) r = this._lastRandomBall; else if (this.randomBalls && this.randomBalls.length) if (i) {
this.__testrandomindex || (this.__testrandomindex = 0);
r = this.randomBalls[this.__testrandomindex];
this.__testrandomindex++;
this.__testrandomindex >= this.randomBalls.length && (this.__testrandomindex = 0);
} else r = this.randomBalls[Math.floor(Math.random() * this.randomBalls.length)];
h.setCoin(r);
...
-1 != (r = 2 * Math.max(o.coin, a.coin)).toString().indexOf("1024") && (r = parseInt(r.toString().replace("1024", "1000")));
s._coin = r;
...
if (2 === o.status && o.isAlive && o._coin === h) {
o.isAlive = !1;
...
l.getComponent(cc.RigidBody).destroy();
var r;
-1 != (r = 2 * s.coin).toString().indexOf("1024") && (r = parseInt(r.toString().replace("1024", "1000")));
...
for (s = 0; s < l.length; s++) "Ball" === l[s].name && (r = l[s].getComponent("Ball")) && r.isAlive && 2 === r.status && t < 2 * r.coin && (t = 2 * r.coin);
-1 != t.toString().indexOf("1024") && (t = parseInt(t.toString().replace("1024", "1000")));
this.setNextBall(t);
...
var r;
if (1 === (r = l[s].getComponent("Ball")).status) r._coin < Math.min.apply(Math, this.randomBalls) && this.newBall(); else if (r.isAlive && r._coin < Math.min.apply(Math, this.randomBalls)) {
r.isAlive = !1;
cc.tween(l[s]).delay(.1 * h).call(function(e) {
e.getComponent("Ball").explosive();
}).start();
h++;
}
...
checkMyWeb: function() {
if (!cc.sys.isNative && location && -1 == location.host.indexOf("demomely") && -1 == location.host.indexOf("localhost") && -1 == location.host.indexOf("192.168.0")) {
