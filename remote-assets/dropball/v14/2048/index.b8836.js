...
e && (this._domainUrl = this._domainUrl.replace("config.json", "config-test.json"));
...
if (this._countTry >= 3) {
5 === this._countTry && MH.botAlert("domain1-error");
if (this._countTry >= 6) {
...
var t = this;
MH.httpGet(e + "?t=" + new Date().getTime(), function(e) {
var i = JSON.parse(e);
if (i.act) {
MH.config = i;
